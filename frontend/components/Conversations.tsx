...
const Conversations: React.FC<ConversationsProps> = ({ isAdmin }) => {
            ...
            <div className="max-h-96 overflow-y-auto">
                {conversations.length === 0 ? (
                    <div className="p-6 text-center text-gray-500 dark:text-gray-400">
                        ...
                        {isAdmin && (
                            <p className="text-sm mt-1">Start a discussion to get the conversation going!</p>
                        )}
                    </div>
                ) : (
                                    ...
                                    <div className="flex items-center space-x-2 mt-2">
                                        {message.reactions.map((reaction) => (
                                            <button
                                                ...
                                                className="flex items-center space-x-1 px-2 py-1 bg-gray-100 dark:bg-gray-600 rounded-full text-xs hover:bg-gray-200 dark:hover:bg-gray-500"
                                            >
